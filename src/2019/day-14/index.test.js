...
let data = promises.readFile(resolve(process.cwd(), 'data', '2019-14.txt'), 'utf8')
...
describe('Part 1', () => {
  ...
  ])('should produce the correct output "%s" for the input', async (output, input) => {
    expect(await part1(input)).toEqual(output)
  })
