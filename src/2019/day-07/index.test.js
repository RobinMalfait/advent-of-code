...
let data = promises.readFile(resolve(process.cwd(), 'data', '2019-07.txt'), 'utf8')
...
describe('Part 1', () => {
  ...
  ])('An input of %s with settings of %s requires an output of "%s"', async (program, settings, output) => {
