...
let data = promises.readFile(resolve(process.cwd(), 'data', '2020-23.txt'), 'utf8')
...
describe('Part 2', () => {
  it.each([['389125467', 934001 * 159792]])('should produce the correct value for example %#', (input, expected) => {
